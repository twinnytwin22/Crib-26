...
export default function Hero() {
  return (
    <header className="overflow-hidden bg-(--neutral-1000) pt-16 text-white">
      <div className="crib-container grid min-h-[calc(100svh-64px)] border-x border-white/15 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="flex flex-col justify-between border-b border-white/15 px-5 py-10 sm:px-9 sm:py-14 lg:border-r lg:border-b-0 lg:px-12 lg:py-16">
          ...
          <div className="my-14 flex flex-col gap-8 lg:my-10">
            <motion.h1
              ...
              className="crib-display  max-w-[8em] text-[clamp(54px,6.4vw,128px)] text-white"
            >
              Web and Technology<span className="text-primary">,</span><br />
             Built for Growth<span className="text-primary">.</span>
            </motion.h1>
        ...
        >
          ...
          <div className="absolute inset-x-0 top-0 flex items-center justify-between border-b border-white/25 px-5 py-4 font-mono text-[10px] uppercase tracking-widest text-white/70 sm:px-7">
